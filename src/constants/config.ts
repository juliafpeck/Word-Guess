export const CONFIG = {
  ...
  language: 'Ladino', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Julia Peck', // Put your name here so people know who made this game!
  authorWebsite: 'YourLinkHere', // Put a link to your website or social media here
  wordListSource: 'Perahya 2012', // Describe the source material for your words here
